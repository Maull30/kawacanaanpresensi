      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl space-y-4 mb-12 sm:mb-16">
          ...
          <p className="text-slate-600 text-xs sm:text-base lg:text-lg leading-relaxed border-l-4 border-blue-600 pl-3 sm:pl-4 font-normal">
            {lang === 'ID'
              ? 'Menjawab kebutuhan nyata guru dan kepala sekolah dasar di Indonesia: presensi cepat, perhitungan hari efektif tepat, dan berkas kedinasan lengkap.'
              : 'Addressing the real needs of elementary teachers and principals in Indonesia: rapid check-ins, exact learning days, and complete Kedinasan documentation.'}
          </p>
        </div>
