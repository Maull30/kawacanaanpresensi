...
export function getKokaLandingResponse(
  ...
  if (/harga|biaya|paket|langganan|tarif|bayar|gratis|free|sekolah\s*pro|guru\s*pro|berapa/i.test(qLower)) {
    return {
      text: "Berikut pilihan paket resmi di KawaCanaan Presensi:\n\n1. **Paket Gratis**: **Rp0 (Aktif Selamanya)** — untuk Ruang Kerja Individu, maksimal 32 siswa SD, 1 rombel, presensi harian & unduh Excel.\n2. **Paket Guru**: **Rp5.000 / bulan** (atau **Rp60.000 / tahun**) — s.d. 5 rombel, 150 siswa, presensi mapel & laporan semester.\n3. **Paket Sekolah**: **Rp25.000 / bulan** (atau **Rp250.000 / tahun** untuk pembelian perdana dengan hemat 2 bulan, perpanjangan tahun berikutnya Rp300.000 / tahun) — Ruang Kerja Sekolah penuh kelas 1-6 paralel, s.d. 1.000 siswa, multi-guru, portal siswa & kop kedinasan.\n\nPembayaran resmi didukung Midtrans melalui QRIS dan Virtual Account bank terpercaya.",
      category: 'pricing',
      suggestions: [],
    };
  }
